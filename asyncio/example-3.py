...
async def main():
    ...
    result1 = await bar # Wait until task1 finishes. task1 runs for 3 seconds it get's blocked so the event loop will execute the next scheduled task task2
    print("completed task1")
    result2 = await foo # Wait until task2 finishes
