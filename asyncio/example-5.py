"""
Blocking the event loop with Sync function. It's a bad practice. It block the entire event loop and we lose concurrency
"""

import asyncio, time

async def fetch_data(param: str, t: int) -> str:
